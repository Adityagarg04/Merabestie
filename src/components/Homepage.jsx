...
function Homepage() {
  return (
    <div
      className="container h-screen  bg-cover bg-no-repeat flex justify-center items-center relative"
  ...
  <img 
    ...
    className="h-7 w-6 transition-all duration-300 ease-in-out opacity-0 group-hover:opacity-100 group-hover:scale-150  "
  />
</button>
