...
function Homepage() {
  return (
    ...
    >
      ...
      <h1 className=" ms-40 font-Kdam text-center p-5 text-[#2B2B2B] bg-[#7D2479] bg-opacity-15 text-7xl  text-opacity-85 rounded-[40px]">
      ...
      <div className=' relative   absolute top-36 left-12  ms-9  '>
        ...
        <img 
        src="craft.jpg"
        className="rounded-full  place-self-center m-7 ml-20  space-y-4 border-2 border-white size-28"
        />
      </div>
